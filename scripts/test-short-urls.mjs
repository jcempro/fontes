#!/usr/bin/env node
// Gerado de scripts/test-short-urls.ts; Node 24+; nao editar.
...
const entries = (result) => Object.fromEntries(result.assignments);
const books = [
...
assert.deepEqual(entries(first), entries(second), "a ordem dos arquivos n\xE3o pode mudar tokens");
